...
* Fixed `modify` producing non-minimal edits: replacing a value no longer deletes the whitespace/newline between the value and a following `}`/`]`, and inserting a new property now appends `,\n<indent>"key": ...` directly after the last value instead of emitting the comma on its own line and dropping the newline before the closing brace [#64][#64]

### Patch Changes

Thanks to [@spencerbeggs](https://github.com/spencerbeggs) for their contributions!

[#64]: https://github.com/spencerbeggs/jsonc-effect/pull/64
